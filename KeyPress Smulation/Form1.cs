...
namespace KeyPress_Smulation
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Process[] processes = Process.GetProcessesByName(comboBox1.Text);
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            comboBox1.Items.AddRange(processes.Select(p => p.ProcessName).Distinct().OrderBy(n => n).ToArray());
        }
        ...
        {
            groupBox1.Enabled = comboBox1.Text.Length > 0;
        }
    }
}
